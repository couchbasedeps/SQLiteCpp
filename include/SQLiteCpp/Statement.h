...
public:
     ...
     */
    void bindArray(const int aIndex, const int32_t array[], size_t size, destructor = nullptr);
    void bindArray(const int aIndex, const int64_t array[], size_t size, destructor = nullptr);
